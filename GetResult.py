import pandas as pd
data = pd.read_csv("./result/FB15K/real/H_DEM.csv",index_col=[0])
reduntest = pd.read_csv("./benchmarks/FB15K/testredun21.txt",sep=" ",skiprows=[0],header=None)
nonetest = pd.read_csv("./benchmarks/FB15K/testnone21.txt",sep=" ",skiprows=[0],header=None)

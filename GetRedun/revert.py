...
# test = pd.read_table("/home/llv19/PycharmProjects/HMH/OpenKE/benchmarks/FB15K/test2id.txt", header=None, sep=' ', error_bad_lines=False, encoding='utf-8', skiprows=[0])
# revers = pd.read_table("/home/llv19/PycharmProjects/HMH/OpenKE/benchmarks/FB15K/000000.txt", header=None, sep=' ', error_bad_lines=False, encoding='utf-8', skiprows=[0])
